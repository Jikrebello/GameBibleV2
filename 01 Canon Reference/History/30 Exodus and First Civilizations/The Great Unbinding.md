...
The sequence below is authorial fact. Its phases overlap, and later traditions may count or arrange their public signs differently.
...
The Lord alone is the source of the Prophet's revelation, the judgement, the commissioned passage, and the heavenly intervention.

The Great Prophet is fully human. He announces, interprets, intercedes, organizes, and performs only commanded acts. He does not generate the plagues as personal sorcery, summon Heaven as a mortal army, or become divine.

The Giant houses are not mind-controlled into war. Judgement exposes betrayals, removes predatory surplus, and brings accumulated claims due. Rulers and courts remain responsible for the violence they choose.

Human liberation also remains human history. Refugees must gather, carry, ration, navigate, bury, repair, judge, confess, defend, and decide whether to abandon the vulnerable. A miracle validates only its actual commission, not every beneficiary, institution, or later claimant.

## The Broad Plague Functions

The number, names, and exact order of individual signs remain open. The following causal functions are fixed:

| Imperial horizon | Systems exposed or severed | Established collapse retained |
|---|---|---|
...
One actual, presently unnamed Phoenix bears the regional judgement-and-restoration commission. Specialized choirs and Host servants support it. Later traditions may conflate the Phoenix, its supporting servants, its commission-bodies, and the visible signs around them, but authorially one Phoenix and many supporting angels were present.

The commission authorizes them to:

- separate captives from self-reproducing Giant structures;
- expose whether an apparent ancestor is a living Titan, living Giant, Reconstruction, office, residue, Idol Mask, or other claimant;
- disable selected replacement bodies, recurrence engines, and generative war routes;
- bind selected Titan-Firstborn or permanently lock their reconstitution;
- break supernatural pursuit long enough for mortal withdrawal;
- preserve the bounded passage until the entrusted movement is complete.

It does not authorize them to:

- conquer or administer Giant civilization;
- judge every casualty as personally condemned;
- become the Prophet's summonable army;
- destroy an Idol Throne or turn a Menhir into a moral judge;
- explain, create, or permanently master the Glass;
- become Patrons or remain as a governing pantheon.

The servants withdraw when the selected structures are contained and the protected withdrawal is complete.

No manifested saint exists before the Redeemer's work. Any white or cleansing fire in the Unbinding belongs to the Phoenix's singular commission. It does not establish a repeatable White-Flame technique, an active saintly relic, or a transferable kindling tradition. No surviving feather, ash, weapon, or camp object retains the Phoenix's authority by default.
...
Human communities also survive outside the principal host. Some rebel after the central columns have passed. Others remain deliberately to hold a city, cannot reach the road, survive in islands or enclaves, or pass through separate successor histories. They are not a rejected or morally inferior humanity, and later genealogy cannot reduce every people to one cart or one bloodline.

A nonhuman Giant may defect, repent morally, or receive temporal mercy. It does not thereby acquire the Image, the human soul-road, sainthood, or status as an ancestor of humanity.
...
- food, seed, breeding stock, tools, medicine, water vessels, shade, carts, and repair craft;
- household and burial records that prevent people from becoming unowned numbers;
...
## Fixed Unknowns and Prohibitions

The following remain deliberately unresolved:

- the Prophet's personal name and complete early life;
- the exact number, names, order, and sensory forms of the plagues;
- the Phoenix's personal name and complete witnessed form;
