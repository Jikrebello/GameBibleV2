...
Both churches agree the Atherian Empire was baptized, died, and must in some sense return. The Split is about *through whom*.

**The Thalmyric claim runs through blood and ground.** Thalmyria holds Caleran — the imperial capital, the Redeemer's execution site, the Pillar of Concordance. It holds an unbroken line of crowned emperors from Caedros I, who died retaking the holy city with the Flame descending on his body. Its argument is continuity: *we never stopped being the empire; we bled it back into existence; the East are provincials who watched.* From Veridun's seat, the Eclessian kingdoms are wayward provinces and the Lord Primarch is a provincial bishop with a large opinion. Fealty is owed westward.

**The Eclessian claim runs through office and trust.** The Church predates the empire's fall and survived it; its Primarchy descends from the **Commission of the Pen** — the Redeemer's charge to Saint Jareth of the Bound Eye ("what you bind in ink shall be bound in memory") — which no emperor conferred and no emperor can revoke. Veridun answers with the **Ember Succession**: from the Pillar itself the Redeemer entrusted his mother to Saint Calira (*"Guardian, behold my mother"*), and the lamp at **Amaryah's hearth in Veridun Minor** — lit from the ember Saint Solana carried out of Caleran, defended to the death by Calira — burns unbroken as the mother-flame of the Eternal Ember. Solana carried it, Amaryah kept it, Calira died for it; the Patriarchate tends it still. Pen against hearth — the primacy dispute was already sitting at the Redeemer's table (see [[The Twelve Companions of the Redeemer]] and [[Amaryah the Fire-Bearer]]). It crowned its own Emperor of the Atherians (Adalmar, 1002) when Veridun's throne sat in heresy and regency, and when Adalmar's line failed it took the **Crown of Embers** into trust — meaning the imperial title is not extinct but *held*, and the Sanctum Divinitatis decides when the realm is worthy of it. Its argument is legitimacy: *empires are things the Church baptizes, buries, and may raise again; Thalmyria is a successful rebellion wearing its grandfather's signet.* Fealty is owed to the office that holds the crown in escrow.

Each claim is strongest exactly where the other is weakest — Thalmyria has the blood and the ground but its crown began with a usurper general; Eclessia has the office and the artifact but no emperor and eleven quarreling realms. Neither can bend the knee without ceasing to be itself. That is why the Split has held for 345 years.

## The Doctrinal Weapon: The Kindling Question
...
Each side's proofs genuinely work, and each side's theology delegitimizes the other's proofs. To Eclessia, Thalmyric "theophany" is unexaminable presumption — sanctified artillery and a self-canonized dynasty ("if the Flame is uncreated, then aiming it is either impossible or blasphemy; choose"). To Veridun, Eclessian "protocol" is a cage for God — grace turned into a currency, which the routing-assurance scandal and the Reformation later proved with interest ("you audited the Fire until it became a fee schedule"). Both accusations are partially correct, which is what makes the dispute permanent.
...
Lord Primarch Bonifac III demanded Veridun acknowledge Simeon's primacy and the Sanctum's trusteeship of the imperial title. Patriarch Makarios the Adamant declined to be lectured by "the keeper of an empty crown." The legate Cardinal Hubald of Caldria, received with calculated insult, nailed the bull of anathema to the Great Lamp of Veridun cathedral with four nails — and every soul present understood the reference. Makarios pronounced the counter-anathema before the nails were cold. Neither anathema has ever been lifted.

## What the Split Does to Daily Life

Dual sainthood registries (a border parish's patron may be a saint on one side of the river and a propaganda exercise on the other); relic passports and contested authentications; rebaptism and marriage-recognition disputes in the borderlands; two competing pilgrimage economies to the same holy city, one of which controls it; mercenary confessors who will bless either army; and the standing nightmare of both hierarchies — that some thin-space event or unburnt object will one day *settle the Kindling Question in public*.
