...
needs:
  - set system-specific poison, concealment, and group-combat values
tags: [game-ready]
...
Blood-Briar Guests are small predatory courtiers that take the shape of thorn-limbed people, root-knotted animals, or flowering scrub when still. They belong to the broad ecology of the [[The Ashen Guest Court|Ashen Guest Court]], especially where hospitality has been broken on roads, treaty grounds, and refuge paths. They are neither the Court's only servants nor proof that every Ashen Guest is murderous.

## What They Are

A Blood-Briar Guest feeds upon fear, exposed blood, and the inversion of welcome. It prefers a victim who has accepted water, shelter, directions, or a truce before being hunted. A Guest that has not established such a threshold can still kill, but loses much of its patience and glamour.
...
- tiny triangular cuts in exposed skin before anyone sees an attacker;
- camp gifts moved into neat but insulting arrangements;
- ears, tongues, or finger joints removed as proof that a warning was "heard";
