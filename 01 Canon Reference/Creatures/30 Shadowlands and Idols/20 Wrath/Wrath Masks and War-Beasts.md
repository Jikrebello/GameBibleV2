...
era: []
region: [Shadowlands, battlefields, feud country, besieged settlements]
culture: []
related_factions: [Wrath, The Red Tally]
appears_in: [The Seven Edges]
needs: []
tags: [game-ready]
aliases: [Wrath Demons]
...
creature_family: Wrath Masks and War-Beasts
catalogued_forms: [Feud-Hounds, Red Reckoners, Pyre-Crowned]
habitats: [Red Marches, massacre sites, war roads, dueling grounds, inherited feuds]
encounter_roles: [pursuer, skirmisher, controller, commander, siege]
related_magic: [Idol manifestation, blood-tally rites, White Flame]
idol_affinity: wrath
manifestation_class: [fauna, mask, archmask]
---
# Wrath Masks and War-Beasts

Wrath's native ecology turns injury into a route. Its creatures are most dangerous when investigators assume that ending the latest fight will end the cause.

## Feud-Hounds

Feud-Hounds are lean furnace-ribbed predators with hide like burned leather and teeth shaped from remembered weapons. They smell not blood but attributed blame.

- **Origin and agency:** animal Idol fauna with limited agency. A hound can choose easier prey but cannot question the grievance pattern that defines prey.
- **Ecology:** a pack forms where retaliation passes to relatives, uniforms, villages, or generations. It dens around trophies, repeated stories, and graves used as recruitment sites.
- **Signs:** pawprints point both directions, old scars heat when a named group is discussed, dogs refuse a family threshold, and ash gathers on inherited weapons.
- **Threat pattern:** marks one victim's allies as accomplices, runs through fire, attacks rescuers before combatants, and howls accusations in the voices of the injured.
...
Pyre-Crowned are autonomous Archmasks resembling immense war leaders crowned by a moving ring of burning banners. Each develops a doctrine of violence and a personal style: ritual duel, extermination, cleansing fire, heroic last stands, or war without surrender.

- **Origin and agency:** sapient Archmask with full moral agency. It understands peace and deliberately makes peace dishonorable.
