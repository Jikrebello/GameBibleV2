...
- edible refuse stripped from places human scavengers ignore;
- low tunnels opening into larger camps;
- several small tracks deliberately crossing to hide the true number;
- gnawed leather, boiled bark, and bone smashed for marrow;
- an apparently dead raider moving again after feeding.
...
Goblins regenerate only while they retain food, blood, and functioning stage tissue. Clean killing trauma, fire, caustic treatment, or separation from food ends the individual biological pattern; Wrath does not receive or resurrect a routed soul. Unwatched remains can still revive briefly when a stage-gland survives, so frontier burial practice destroys the gland before disposal.
