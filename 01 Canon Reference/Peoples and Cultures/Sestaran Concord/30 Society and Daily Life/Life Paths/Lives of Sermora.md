...
The canal-republic: a navy pretending to be a market, a spy service pretending to be a government, and the most beautiful city in the world pretending not to count your ships while you talk.
...
The republic's signature life: sailor at twelve, prize-crew at eighteen, and then the paper that defines everything — the **letter of marque**. A licensed privateer is navy-when-needed, pirate-with-receipts otherwise; prizes condemned in the **prize courts** (where the real fights happen — a good prize-advocate earns more than a good captain), shares paid by strict custom down to the powder-boys. The forks: whose flag to hunt (the letters name lawful prey, and the season's diplomacy rewrites the list — a captain caught holding *last month's* license is a pirate retroactively, which is the Admiralty's favorite leash); the haven winters (the pirate isles' politics — canon — where retired captains rule coves like abbots); and the career's terminal question: the Admiralty buys aging captains respectable — harbor offices, convoy commands — *if* their logs stay consistent with the republic's official memory. Most logs learn to.

## The Courtesan-Informant (the salon road)
