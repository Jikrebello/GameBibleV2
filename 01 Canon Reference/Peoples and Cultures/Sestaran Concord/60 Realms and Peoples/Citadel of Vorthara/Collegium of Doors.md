...
The Collegium occupies a compact campus near the lower Black Spire. Its doors, corridors, and courtyards are rebuilt continually by senior students. Ordinary Vortharans know it chiefly through **Breach-Week**, the annual festival when its grounds open for public ward-breaking trials.

## Training

Students learn four practical disciplines:

- **Exclusion:** keeping a named force, creature, element, or method outside.
- **Containment:** limiting what something can do after entry.
- **Redirection:** sending intrusion into prepared space rather than stopping it directly.
- **Counter-breach:** observing how protections fail and changing them before the next attempt.
