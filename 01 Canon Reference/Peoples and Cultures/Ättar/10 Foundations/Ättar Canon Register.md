...
related_factions: ["Thalmyric Empire", "Folk", "Grobi"]
appears_in: []
needs: []
tags: []
---
...
- Slavery, slave trading, forced labor, and coerced sexual access are common and objectively evil.
- A thrall-born child follows the mother's status unless publicly acknowledged, freed, and named by the father. The mother's status does not change automatically.
- A lawful berserker challenge may test a chief accused of cowardice, tyranny, or moon-loss. Refusal breaks hall-right.
- A sincerely baptized hall renounces the pact. It can retain Ättar culture but cannot renew a skinwalker chief.

## Fixed Geography

- The four customary ranges remain AT1-AT4 on the political map.
- The Saltborn heartland is the rugged **western Kedravan coast**. Halmenth, the Celion estuary, Soligrad, and the Thirty Sisters belong to that coast.
- Saronika and Caleran may contain Saltborn migrant and naval districts, but the eastern Thalassian shore is not the Saltborn homeland.

## Superseded Claims

The Great Prophet is not authorially the First Skinwalker. Per-transformation memory sacrifice, inevitable catatonia, a single four-tribe confederation, and an eastern Saltborn homeland are obsolete.
