...
archived_from: "01 Canon Reference/Peoples and Cultures/Thalmyric Empire/60 Realms and Peoples/The Saltborn Coast Overview.md"
archived_on: "2026-07-12"
superseded_by: "The Saltborn Coast Overview"
type: culture
era: ["Present Day"]
...
appears_in: []
needs:
  - place the Saltborn coast towns on the final eastern-Thalmyria map
...
The coast is the old **Atherian maritime war-front**, and its people are the sediment of everyone who ever came at it by sea:

1. **Atherian frontier.** Under the old empire this was the exposed seaward march — garrison ports, beacon-chains, and fisher-towns holding the Thalassian edge. The deep substrate of the Saltborn is Atherian: imperial coast-stock, hard-used and sea-facing.
2. **The Ättar raiding age (c. 400–540 AR and after).** The Ättar fjord clans of the south ranged their keels up the Thalassian and fell on this coast for generations. Raid became truce became settlement, and half-assimilated Ättar enclaves took root among the Atherian coast-towns — the raid-then-settle that gives the Saltborn their name and their blood.
3. **Ahl-e-Ahd invasion.** From the west strait at **Qazmarid** and the southeastern desert-and-Thalassian approach, the Covenant launched its own invasions against the same shore across the centuries — the seaward arm of the wars that also broke Caleran. The coast learned to be invaded and to endure it, which is the whole Thalmyric temperament in miniature.
4. **Thalmyric baptism.** The Aetherion throne and the Patriarchate of Veridun claimed the coast and its people, folding the Saltborn into the empire and the Holy Fire — baptized, levied, and taxed, but never quite scrubbed of the sea-totem underneath.

## Character and Custom

The Saltborn are **Thalmyric in faith and allegiance, Ättar in the bone, Atherian in the foundations** — and entirely their own on the water.

- **Names:** a saint's name for the font and a totem byname for the boat — *Osric Sealsson*, *Halla Gull-Hand* — and no one explains the second to the bishop.
- **Faith:** the Holy Fire keeps their calendars and their chapels, but the sea keeps their real superstitions. **Saint Naris**, drowned off Halmenth, is the coast's own martyr-saint, and the Naris cult routes the souls of those lost at sea.
- **Weddings:** mead at the church door (an Ättar survival the Church gave up fighting) and a sea-totem knot braided into the bride's crown.
- **Craft:** fisher-lords, keel-wrights, coast-guards, and pilots; the coast's wealth is herring in twenty forms, salt-cod, stockfish, and the ships themselves.
- **The horizon:** every Saltborn town watches the sea with complicated feelings, because the sail on the water may be a cousin, a raider, or an invasion, and has historically been all three.
