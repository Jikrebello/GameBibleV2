...
region:
  - Emerald Expanse
  - Material Realm
  - Country Beneath the Rains (provisional)
culture:
  - unassigned Orphaned humans
related_factions:
  - Castaran expeditions
  - Giant client polities
  - local Menhir courts
  - Idol Masks
appears_in: []
needs:
  - map the surface catchment without touching a Bird-Marked Site
  - name and research surface and subterranean peoples separately
  - assign the Giant client estate to an imperial horizon only after the Giant-Age map exists
  - determine the controlling Menhir sovereignty behind local water and stone court-laws
  - decide whether first Castaran contact occurs in a future playable campaign
  - create separate creature dossiers before promoting any endemic animal or legacy being
tags:
  - research
  - subterranean-worlds
  - Emerald-Expanse
...
```mermaid
flowchart TB
    Surface[Surface Catchment<br/>forest, rivers, local peoples]
    Mouths[Green Mouths<br/>light wells, roots, cataracts]
    Galleries[Broken Galleries<br/>Giant works and later roads]
    Rain[Rain Country<br/>inhabited basins and rivers]
    Furnace[Furnace Roots<br/>heat, metal and toxic industry]
    Vaults[Made Vaults<br/>separate purposes and laws]
    False[False Depths<br/>thresholds into other jurisdictions]
    Elsewhere[Unbroken rock<br/>no worldwide connection]

    Surface --> Mouths
    Mouths --> Galleries
    Galleries --> Rain
    Rain --> Furnace
    Galleries -. individual entrances .-> Vaults
    Rain -. individual entrances .-> Vaults
    Furnace -. individual entrances .-> Vaults
    Mouths -. rare threshold .-> False
    Rain -. rare threshold .-> False
    Furnace --- Elsewhere
```
