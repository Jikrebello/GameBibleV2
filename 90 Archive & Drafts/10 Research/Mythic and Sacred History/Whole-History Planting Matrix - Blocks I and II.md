...
- **World Egg torque:** a record cannot create a soul, but repeated naming prevents estate offices from reducing people to transferable functions and denies Envy's replacement Masks an easy route through deliberate erasure. During the Unbinding, compared name, household, burial, and work records help human registrars distinguish a living person from an estate number, recurrence performance, missing captive, or royal copy-claim.
...
- **World Egg torque:** inside a Gluttony dominion overlay, the Bread-Bearer briefly reveals exactly who has been denied a place. The loaf is enough to share but does not multiply into endless food. The revelation lets the cooks identify and dismantle one feeding architecture; their witnessed ration measure can later pass into gathering practice without reproducing the Counter-Countenance event.
...
- **World Egg torque:** the cart's repeated wheel-song names the people, duties, burial places, ration measures, and route corrections immediately ahead and behind it, preserving a narrow social orientation through Glass reflections. The crew's defining roles are provisioning, cart repair, medicine, route-and-name memory, burial, and defence of people others would abandon. High signs answer only impossible bottlenecks; they neither perform these duties nor turn them into repeatable miracle techniques. The crew inherits anonymous practices resembling Bowl registers, Broken-Measure accounting, service-door songs, midwife lists, and funeral roads; the braid is accumulated human craft, not a competing revelation, bloodline, or surviving secret order.
