...
- **Count:** exactly twelve independent hooks.
- **Density:** trace or local-cycle scale; none is a new signature company.
...
## TF-01 — The Empty Seat at the Outward Threshold

- **Placement:** c. 2165–2140 BR; the Prophet's death and first departure hearings.
- **Humble aperture:** the workers responsible for carrying, repairing, and placing the Prophet's ordinary judgement seat discover that every office wants it placed beside its own speaker.
- **Causal chain:** the Prophet dies without naming a universal successor → the camp must decide route, stores, punishment, and land policy → officers argue over who may sit in the place from which his judgements were heard → a commander orders the seat placed behind his guard line → unarmed petitioners try to recover it, guards strike them, and several people die in the crush and fighting → the surviving judges order the seat dismantled or left empty → later councils preserve an empty place but disagree whether the original seat was destroyed, hidden, or carried south.
- **Source grammar:** Numbers 27, Deuteronomy 34, and Joshua 1 by deliberate contrast: Joshua receives an explicit commission, while this history does not; Judges 2 supplies the loss of the founding generation.
- **Culpable actors:** the commander who turns custody of the seat into a succession claim and guards who use unlawful lethal force against petitioners.
...
- **Placement:** c. 2050–2000 BR; first durable proto-Atherian footholds in inhabited country.
- **Humble aperture:** a local servant, hostage, or junior gate-keeper bargains with an approaching southern league against the house presently ruling the stronghold.
- **Causal chain:** the league needs grain and a defensible crossing → a faction inside the stronghold offers admission in exchange for protection and restoration of confiscated property → the league enters before dawn → commanders kill the ruling garrison but also permit soldiers to murder resisters, seize households, and divide captives → the allied local faction receives only part of what was promised → the fort becomes a permanent settlement whose land register treats conquest allotments as lawful first ownership.
- **Source grammar:** Joshua and Judges 1 on entry, alliance, warfare, incomplete settlement, and coexistence; dangerous-hospitality and Greek colonial-foundation grammars supply the political form.
- **Culpable actors:** the league commander who permits killing and captive division, participating soldiers, and local conspirators who knowingly deliver rival households into the attack.
- **Hard edge:** the capture includes massacre, enslavement, betrayal of local allies, and land seizure. The story cannot be rewritten as bloodless liberation simply because the previous ruler was also oppressive.
...
- **Placement:** c. 2020–1920 BR; a proto-Atherian fort and one Folk great clan.
- **Humble aperture:** children and adolescents exchanged to secure a truce grow up learning the law, language, kinship, and weaknesses of the other community.
- **Causal chain:** repeated raids threaten both the fort's harvest and the clan's winter stores → leaders exchange hostages and foster children → mixed households and trade reduce open war → a fort officer executes one returned hostage for warning the clan about a planned seizure → the clan kills settlers and captives in retaliation → surviving fosterlings prevent total destruction but are treated as suspect by both sides → their descendants create a border custom requiring two kin-groups to witness any hostage's punishment.
- **Source grammar:** Judges 1–2 on incomplete conquest and entangled populations; Greek and northern-European fosterage and hostage traditions provide the comparative political grammar.
- **Culpable actors:** the officer who orders the unlawful execution, the superiors who protect that decision, and clan war leaders who answer it by killing settlers and captives without distinguishing responsibility.
...
- **Placement:** late Scattering into early Hearths; one future Sestaran contact zone.
- **Humble aperture:** local pilots, net-makers, warehouse families, refugee boat crews, and a damaged proto-Atherian convoy all require the same storm harbor.
- **Causal chain:** the convoy cannot continue without repair and food → harbor elders grant a seasonal quarter under toll and guest terms → the settlers fortify their quarter and use armed control of the grain store to extend their stay → resisters are killed, sold, or driven inland while other households join the new market → local pilots later help destroy a punitive fleet sent by the settlers' parent league → the surviving harbor becomes an independent mixed city which preserves both occupation and liberation as competing “first foundations.”
- **Source grammar:** Mediterranean colonial encounter, synoecism, refugee foundation, and mixed maritime-migration grammar; the scriptural pressure is Judges' repeated coexistence, alliance, and domination after incomplete conquest.
- **Culpable actors:** settler officers who weaponize emergency grain and violate the seasonal agreement, harbor and league agents who traffic captives, and punitive commanders who attempt collective retaliation.
- **Hard edge:** refuge becomes occupation; grain control, killing, enslavement, and retaliatory naval destruction are integral. Braiding is not automatically peaceful.
...
- **Culpable actors:** mine rulers, merchants, and officials who enforce hereditary labor and purchase captives, together with war leaders who burn the food and fuel systems sustaining uninvolved settlements.
...
- **Placement:** c. 1920–1840 BR; northern dry belt before the full Jirahar–Ahdari fission.
- **Humble aperture:** well-cleaners and animal-waterers must apply three incompatible claims during a long drought.
- **Causal chain:** a seasonal well has been used by Tarkhan families, Near-Glass caravans, and an older settled community → drought reduces the flow below ordinary need → camp registrars demand ration by counted persons, Tarkhan elders demand their inherited season, and local guardians demand priority for those who maintained the shaft → armed guardians close the well while the case is argued → people and animals die on the road → retaliatory raiders kill members of the guardian households → the eventual settlement distinguishes emergency drinking water, maintained storage, and seasonal herd access instead of declaring one people sole owner.
- **Source grammar:** Genesis 21 and 26 on wells, oath, dispute, and witnessed settlement; Numbers 20 supplies the bodily urgency of water without copying its miracle.
- **Culpable actors:** guardians who knowingly close drinking access, officeholders who prolong the dispute while people are stranded, and retaliatory leaders who kill beyond the responsible guards.
...
- **Placement:** c. 1870–1780 BR; a decisive but local episode in the northern fission.
- **Humble aperture:** two related communities share judges, marriages, burial obligations, and winter stores but disagree over rebuilding after a raid.
- **Causal chain:** raiders burn an open settlement and carry off dependants → one coalition proposes a permanent wall around the principal well and stores → the wall-builders require labor, property registration, and an inherited protector household → the travelling court agrees to temporary defense but refuses permanent jurisdiction over absent caravan families → wall-builders confiscate the absent families' stores and bar their return → kin on both sides fight at the gate and kill one another → survivors retain shared marriages and graves while developing different courts, calendars, and political loyalties.
- **Source grammar:** 3 Kingdoms 12 on burden, arrogant rule, and enduring division; Judges supplies the recurring problem of local defense without stable universal government.
- **Culpable actors:** protector leaders who turn emergency custody into inherited seizure and armed members of both coalitions who choose lethal force against returning kin.
- **Hard edge:** captives motivate the fortification, confiscation makes dependants destitute, and relatives kill one another. Neither mobility nor walls are presented as morally innocent.
...
- **Placement:** c. 1860–1760 BR; Near-Glass and Tarkhan border society.
- **Humble aperture:** a young woman from a Near-Glass office-holding family is married under a peace settlement to a Tarkhan route household after both sides exchange captives.
- **Causal chain:** a cycle of caravan seizure and well retaliation is exhausting both groups → leaders arrange marriage, fosterage, and captive return → the bride enters the Tarkhan household with a written witness list while her brother remains as security elsewhere → her husband's kin later demand that she surrender fugitives protected under guest-law → she refuses, and armed relatives kill her brother during the resulting confrontation → she publicly dissolves the alliance under the agreement's own terms and leads dependants to another route → her children and followers preserve a mixed maternal law neither later tradition can claim exclusively.
- **Source grammar:** Genesis 31 on marriage, household grievance, departure, boundary, and oath; broader dynastic marriage and hostage grammars provide the coercive political setting.
- **Culpable actors:** elders who constrain the marriage through captive exchange, the husband's relatives who demand betrayal of protected guests, and the armed kin who kill the peace-hostage.
- **Hard edge:** the marriage is constrained by public necessity, captives remain bargaining pieces, and refusal to betray guests leads to a kinsman's death. The woman's legal intelligence does not make the coercive arrangement benevolent.
...
- **Placement:** c. 1800–1650 BR; Folk–Ättar cousin divergence before the War of the Empty Halls.
- **Humble aperture:** related inland and coastal communities share kin obligations, but a southern hall must choose between joining a northern feud against proto-Atherian settlers and maintaining the winter Grobi watch.
- **Causal chain:** northern cousins invoke an old obligation after settlers seize burial land → southern scouts report a Grobi movement toward undefended valleys → the hall refuses the northern muster and draws neighboring households into a permanent winter defense compact → the northern clan loses people and land while waiting for aid → survivors denounce the hall as oath-breakers → the southern compact's halls, ships, stores, and warrior followings become increasingly unlike inland Folk institutions.
- **Source grammar:** Judges' local deliverer cycles and northern hall-defense traditions; the source element is the conflict between bounded defense and wider kin obligation rather than a single copied episode.
- **Culpable actors:** hall rulers knowingly accept the likely abandonment of their northern kin, while northern feud leaders rely upon disputed aid instead of evacuating exposed households. Neither created the Grobi threat.
- **Hard edge:** refusing one legitimate obligation leaves relatives to be killed or displaced; meeting the other saves households from a real Grobi threat. The choice remains tragic rather than secretly easy.
...
| Pressure | Hooks |
|---|---|
| vacant commission and competing offices | TF-01, TF-02 |
| southern conquest and early braiding | TF-03, TF-04, TF-05 |
| recovery economy and its collapse | TF-06 |
| northern fission and Tarkhan agency | TF-07, TF-08, TF-09 |
| Folk–Ättar divergence and Grobi pressure | TF-10 |
| heroic-maritime Atherian rise | TF-11 |
| Caleran civic and republican appropriation | TF-12 |
...
- [x] No conquest is divinely commissioned.
- [x] Orphaned actors retain knowledge, interests, alliances, culpability, and agency.
- [x] No hook creates all members of a later people.
- [x] No hook creates a signature company or causes an entire age.
- [x] No hook explains the Glass, Year of Standing Stars, Mother Moon's bargain, Nine Wells, or another protected Weird or established event.
- [x] Every 1360 AR trace remains useful even if the associated personal legend is false.
- [x] All personal names, precise locations, and complete biographies remain open.
