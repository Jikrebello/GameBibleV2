...
archived_from: "01 Canon Reference/Cosmology/20 Realms and Soul-Routes/The Image, Soul, and Creaturely Continuity.md"
archive_reason: "Snapshot before created heavenly spirits were restored to the continuity doctrine."
superseded_by: "[[The Image, Soul, and Creaturely Continuity]]"
era: []
region: []
culture: []
related_factions: []
...
Shared ancestry does not by itself preserve the Image. Intelligence, affection, pain, culture, moral choice, or the ability to speak do not create a human soul. Magic, a Menhir court, an Idol, a patron, a contract, or a sufficiently exact copy cannot manufacture the Image.

This distinction must never become an excuse for lazy creature writing. A being without a human soul may still suffer, reason, form loyalties, keep promises, betray others, or bear moral responsibility according to the kind of agency it possesses.
...
An apparition that remembers a dead person is therefore not automatically that person. The decisive questions are what continuity animates it, whether the human soul is still present, and what permanently ends the condition.

## Grobi

The first Grobi were human beings physically rewritten by [[Wrath]]. The transformation did not corrupt their souls into Grobi souls. It severed the victims' human souls from the altered bodies, and those souls continued toward judgement. The Wrath-shaped biological pattern then reproduced on its own.
...
Hell contains more than one kind of being:

- refusing human souls and the transformed damned;
- native Depth fauna that never possessed human souls;
- imposed offices and contractual mantles;
- soul predators and jailers;
- Abyssal wound-beings whose existence is a tear or refusal made active.
