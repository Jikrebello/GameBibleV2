...
required_states: ["elara_companion_quest_1_complete"]
optional_state_inputs: ["vasko_trace_state", "customs_porter_state", "grave_goods_state", "vale_standing", "hunter_services", "root_witness_boundary"]
field_experience_gate: ["elara_rescue_priority_observed", "elara_delving_choice_observed", "elara_companion_intervention_observed"]
companion_required: "Elara Velescar"
duo_quest: true
pause_points: ["Ashfield Reconnaissance Complete", "Workers Secured Before Descent"]
relationship_gate: "Names Beneath Lime complete and no unresolved blocking conflict"
archive_reason: "Snapshot before Elara's ten-piece companion campaign retrofit"
archived_from: "02 Playable Settings/Grenzburg/50 Campaign/Companions/CMP-01 Elara Velescar/A House Fed by Bones.md"
archived_on: 2026-07-24
superseded_by: "[[A House Fed by Bones]]"
---
# A House Fed by Bones

## Quest Function

Elara's second personal adventure is a full Southwood expedition. It turns her copied methods into a current danger, gives the workers faces and agency, and tests whether she will abandon proof or treasure when people are beneath unstable stone.

The active party is the player and Elara. Kata and rescued diggers may assist as temporary NPCs outside the squad limit.

## Unlock and Staging

After the required Field Familiarity beats, a messenger from [[Ashfield Lodge]] reaches Elara at the next camp or hub. Hunters stopped one cart carrying Velescar-marked survey pages. A second cart and its labor crew continued toward [[Seven Mounds]].

The quest stages from Ashfield Lodge. Accepting the closed expedition dismisses the other active companions. The player chooses supplies, route, dart preparation, and any faction support before departure.

## Immediate Situation

Vasko has adapted Elara's old field book to a Southwood mound. His crew intends to breach the names chamber before winter closes the road. Workers are tied to the job through inherited fines, food advances, threatened households, and armed oversight.

The current excavation is not required to prove the old Virelian crime. Its purpose is profit and destruction of evidence: Vasko expects the mound to contain portable memorial goods and plans to bury copied correspondence in the final collapse.

## Principal Cast

- [[Elara Velescar]]: recognizes her notation and must confront how portable her methods became.
- [[Vasko Dren]]: excavation master, human boss, and author of the collapse contingency.
...
- **2:** Vasko places powder and begins removing markers.
- **1:** lower niche opens and residue activates.
- **0:** Vasko attempts extraction and collapse; the quest advances to the emergency sequence.
...
- Elara recognizes her survey shorthand and a correction held only in Vardek's cabinet;
...
Vasko argues over the site only to buy excavation time. He is willing to abandon his guards and workers.
...
The player stabilizes, bypasses, or races through supports weakened by Vasko. A failed interaction causes injury, noise, and Shoring loss, not an arbitrary party kill.
...
Vasko's crew has reached portable memorial goods and a packet of correspondence intended for destruction. Kata identifies workers trapped behind a failed partition while Vasko prepares his exit.

## Climax: People Beneath Stone

Vasko fires a partial powder line, separates the lower niche, and retreats toward the crown shaft with the correspondence. The main support begins to fail.

The duo faces two immediate objectives:

- release and extract trapped diggers;
- prevent Vasko escaping with or destroying the evidence.
...
- the vertical route intercepts Vasko;
- preserved powder tools open a second rescue hole;
- hunter support receives people outside once signaled.

Without those advantages, the player must personally divide time. Elara proposes going after Vasko first. Her response to correction depends on prior accountability: an Open or Trusted Elara can be called back to the workers; a Strained Elara requires the player to take the rescue route while she pursues.

## Vasko Confrontation

Vasko fights through ropes, powder, loose stone, crossbow pressure, and escape routes. He has no supernatural protection.

- **Captured:** all exits are denied and he is defeated after his demolition leverage is removed.
- **Killed:** he dies during combat, collapse, or chosen lethal escape.
- **Escaped:** he leaves through an unsecured crown or forest cache.

Surrender after capture must be honored or judged as a deliberate execution. His status changes later encounters but never gates their essential evidence.
...
- Vardek's chain appears in correspondence, payment seals, or Vasko testimony.
...
- The cabinet correction appears in a copied note, Vasko's case, or an encoded payment instruction.
...
- If all correspondence burns, Vasko's route plate and Customs records still reach Vardek.
- If the mound collapses, surface spoil preserves some names while future access closes.
- If Vasko escapes, he strengthens the winter chase rather than cancelling it.
...
Completion opens **Without the Powder**, the second relationship-interest scene.

## Seasonal Transformation

If spring arrives first, Vasko's crew has already opened and stripped the lower niche. The transformed quest becomes rescue, body recovery, and pursuit through a scarred mound. The field book is dispersed, Kata begins injured or missing, and full preservation is no longer possible.
...
- relationship scene and qualitative approval movement.
