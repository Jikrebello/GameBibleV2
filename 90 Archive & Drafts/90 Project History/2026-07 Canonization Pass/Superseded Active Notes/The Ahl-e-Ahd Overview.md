...
appears_in: []
needs: []
superseded_by: "[[01 Canon Reference/Peoples and Cultures/Ahl-e-Ahd/The Ahl-e-Ahd Overview]]"
tags:
  - core-canon
...
Court and state titles are **translation-convention** (caliph, sultan, emir, vizier, ibn/bint, Banu-dynasties — as king/duke elsewhere). The **religious-legal layer** uses contract-lexicon coinages: **Aqid** (pl. Aqidin — preacher-elder, "contractor of souls"), **Wasi** (pl. Wasiyin — designated executor; the Sealed Blood's Veiled Wasiyin), **sealed ruling** (not fatwa), **breach-judge** (not qadi), **the Unsealing** (holy war). Forbidden verbatim: jihad, fatwa, imam, sheikh, and directly liturgical vocabulary. The Covenant tongue is the **flowing branch** of the desert family — its jurists can almost read the Jirahar Sifra, and find this humiliating.
