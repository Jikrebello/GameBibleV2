...
source: PZO9500-4 Master of the Fallen Fortress
era:
  - Present Day
region:
...
**Source:** *Master of the Fallen Fortress* | **Tier:** R starter | **Region:** Grenzburg approaches | **Band:** level 1 analog

## Original Adventure: Spark Notes

### Background

Outside a great city stand the ruined siege-castles of old wars, long picked over and long avoided. An earthquake cracks one of these towers open, exposing halls sealed for centuries. Two newcomers move in almost at once. First, an outcast reptile-folk druid and his small band of followers, who slip up from the tunnels below and are then trapped above ground when an aftershock seals the way back down; their leader decides his god has handed him this fortress as the seedbed for his people's conquest of the surface. Second, a lone treasure-hunting explorer from a society of adventurer-scholars, who hears the tower has opened, goes in to make his name, does not realize it is occupied, and is captured.

### Beginning: The Job and the Door

1. Word spreads that the fortress has cracked open and its lower floors are exposed for the first time in living memory.
2. The party is hired — or lured by rumor of treasure — to enter the tower, and often to recover the missing explorer who went in and never came out.
3. The ground floor is the first test: a defended entrance and the immediate sense that the ruin is not empty.

### Middle: The Vertical Delve

1. The tower rises in floors rather than spreading in halls, so the adventure climbs instead of branching — each floor a small cluster of chambers to clear before the stair up.
2. The floors hold the newcomers' guards, the ruin's own long-dead residue, traps and hazards left by the quake, and the occasional buried valuable.
3. The captured explorer is held somewhere up the tower, and clues to his fate accumulate as the party climbs.
4. The delve teaches basics by repetition: careful advance, resource use, when to fight and when to talk, and how to read a dangerous ruined space.

### End: The Master of the Tower

1. Near the top the party confronts the self-appointed master of the fortress — the outcast druid — and his closest guards.
2. Defeating or driving him off frees the captive and ends his grandiose plan before it begins.
3. The reward is the recovered explorer, the tower's exposed treasures, and the standing of having cleared a fabled ruin — a first name made in the adventuring trade.
...
- Two newcomer occupants plus the ruin's own old dead, layered in one small site.
- A captive held up the tower as the spine of the delve.
