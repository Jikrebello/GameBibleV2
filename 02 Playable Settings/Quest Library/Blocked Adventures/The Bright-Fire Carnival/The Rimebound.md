...
- a Cloven's grace gone brittle; frost at the joints, breath that fogs in spring;
- bargains offered with no proportion — everything for anything, the whole town for a grove;
- the taking of years, names, and warmth from the innocent as readily as the guilty;
- a daytime delight — funhouse, tunnel, menagerie, tent — turned to a version that takes rather than gives;
- moments of the original Cloven surfacing: a hesitation, a grief, a collector appalled at itself.

## Encounter Role

Rimebound are gauntlet-horrors and tragic antagonists, not simple monsters. They are the mechanism by which the carnival's attractions become lethal after the third-night fires, and each is a Cloven the party may have spoken to, bargained with, or been warmed by hours earlier. Fighting them is fighting the wronged party's own people after a predator got inside them.

## Behavior and Tactics

- collect without limit, using the attraction or grove they are bound to as terrain and weapon;
- honor no proportion, because the cold has taken it — the letter of the inflated debt is all that remains;
- take warmth and years to sustain the collection, growing colder and stronger as the night runs;
- falter when the original Cloven surfaces — a name spoken, a grief named, the true debt shown;
- collapse or free when the Rider's hold breaks, rather than when merely wounded.
