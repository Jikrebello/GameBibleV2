...
era: ["Present Day"]
region: ["Sylvan Marches", "Southern Forests", "Faewild edges"]
culture: ["Fäskogarfolk"]
related_factions: ["The Cloven"]
appears_in: ["The Bright-Fire Carnival"]
needs:
  - assign encounter and bargain values for common Cloven types in the chosen game system
tags: [module-conversion, game-ready, fey]
---
# The Cloven
...
The Cloven do not arise from devotion but from pressure: where Sylvorn's law concentrates — old growth, moving groves, root-cairns, ground too fertile and too attentive — the forest throws up intelligences that behave like the food-web given manners. They embody succession, territorial memory, fertility-pressure, and predation-as-law. A Cloven is the forest briefly wearing a person, and it never entirely stops being the forest.
...
- **Thorn-maids and alder-maids:** grove-law wearing a woman's shape; collectors, hosts, and the surviving faces of specific stands (Sisrin is one).
- **Fauns and satyrs:** revel-keepers and lure-makers; the carnival's barkers, dancers, and games-masters.
- **Grove-spirits:** bound to a place or an attraction; the intelligence inside a funhouse, a tent, a caged wonder.
- **Beautiful hazards:** plants and beasts with just enough mind to bargain — singing thickets, kind-eyed menagerie animals, sweet fruit with a price.

## Signs

- grace and stillness that do not fit the setting, and a chill that does not fit the season;
- gifts, prizes, and treats that leave a faint absence behind — a name, a laugh, a year;
- fortunes and favors offered for "small, unnoticed things";
- fungal blooms in map-like arcs, thorn-growth on doorframes overnight, animals watching without fear;
- speech that is exact about what is owed and indifferent to what is deserved.
